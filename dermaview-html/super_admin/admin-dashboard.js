    ...
    return `
      <section class="dashboard-shell">
        <div class="dashboard-hero panel-card">
          <div>
            <span class="dashboard-kicker">Super Admin Overview</span>
            <h3>System Command Center</h3>
            <p class="section-text">Full-system governance across accounts, patients, appointments, consultations, image records, access control, privacy, backup, and system alerts.</p>
          </div>
          <button type="button" class="dashboard-refresh" id="dashboardRefresh">Refresh</button>
        </div>

        <div class="dashboard-stat-grid super-admin-stat-grid">
          <div class="dashboard-stat-card panel-card">
            <span>Total Users</span>
            <strong data-stat="users">--</strong>
            <p>Super admin, admin, staff, and employee accounts</p>
          </div>
          <div class="dashboard-stat-card panel-card">
            <span>Total Patients</span>
            <strong data-stat="patients">--</strong>
            <p>Patient profiles and appointment-linked records</p>
          </div>
          <div class="dashboard-stat-card panel-card">
            <span>Total Appointments</span>
            <strong data-stat="appointments">--</strong>
            <p>All recorded appointment requests</p>
          </div>
          <div class="dashboard-stat-card panel-card">
          ...
          <div class="dashboard-stat-card panel-card">
            ...
            <strong data-stat="completed_consultations">--</strong>
            <p>Finished appointment records</p>
          </div>
          <div class="dashboard-stat-card panel-card">
          ...
          <div class="dashboard-stat-card panel-card">
            ...
            <strong data-stat="uploaded_images">--</strong>
            <p>Original consultation image records</p>
          </div>
          <div class="dashboard-stat-card panel-card">
            <span>Processed Images</span>
            <strong data-stat="processed_images">--</strong>
            <p>Uploaded or processed image records</p>
          </div>
          <div class="dashboard-stat-card panel-card">
            <span>Active Staff</span>
            <strong data-stat="active_staff">--</strong>
            <p>Enabled staff and employee accounts</p>
          </div>
          <div class="dashboard-stat-card panel-card">
            <span>System Alerts</span>
            <strong data-stat="system_alerts">--</strong>
